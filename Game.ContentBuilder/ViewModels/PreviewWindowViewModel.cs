    ...
    private void Generate()
    {
        try
        {
            ...
            List<PreviewItem> items = SelectedContentType switch
            {
                ...
                "Enemies - Beasts" => _previewService.GenerateEnemyPreviewsByType(EnemyType.Beast, 5, Count),
                "Enemies - Demons" => _previewService.GenerateEnemyPreviewsByType(EnemyType.Demon, 5, Count),
                "Enemies - Dragons" => _previewService.GenerateEnemyPreviewsByType(EnemyType.Dragon, 5, Count),
                "Enemies - Elementals" => _previewService.GenerateEnemyPreviewsByType(EnemyType.Elemental, 5, Count),
                "Enemies - Humanoids" => _previewService.GenerateEnemyPreviewsByType(EnemyType.Humanoid, 5, Count),
                "Enemies - Undead" => _previewService.GenerateEnemyPreviewsByType(EnemyType.Undead, 5, Count),
