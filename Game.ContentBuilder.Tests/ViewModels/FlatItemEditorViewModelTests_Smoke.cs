...
/// <summary>
/// Smoke tests for FlatItemEditorViewModel - validates basic functionality
/// Tests flat item structure (e.g., metals, woods, leathers)
/// </summary>
public class FlatItemEditorViewModelTests_Smoke
{
    ...
    public void Constructor_Should_Not_Throw_With_Valid_File()
    {
        ...
        var fileName = "items-materials-metals.json";

        // Act
        Action act = () => new FlatItemEditorViewModel(service, fileName);

        // Assert
        act.Should().NotThrow("FlatItemEditorViewModel should construct without errors");
    }
    ...
    public void Constructor_Should_Initialize_Items_Collection()
    {
        ...
        // Act
        var viewModel = new FlatItemEditorViewModel(service, fileName);
