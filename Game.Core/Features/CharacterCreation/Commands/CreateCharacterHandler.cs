...
public class CreateCharacterHandler : IRequestHandler<CreateCharacterCommand, CreateCharacterResult>
{
    ...
    public Task<CreateCharacterResult> Handle(CreateCharacterCommand request, CancellationToken cancellationToken)
    {
        // TODO: CharacterCreationService needs DI refactoring - temporarily disabled
        throw new NotImplementedException("Character creation temporarily disabled - needs DI refactoring");
        
        /* DISABLED - CharacterCreationService needs refactoring
