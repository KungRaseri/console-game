...
1. `Game.Data/Data/Json/npcs/common/` (directory)
2. `Game.Data/Data/Json/npcs/craftsmen/` (directory)
3. `Game.Data/Data/Json/npcs/merchants/` (directory)
4. `Game.Data/Data/Json/npcs/professionals/` (directory)
5. `Game.Data/Data/Json/npcs/military/` (directory)
6. `Game.Data/Data/Json/npcs/criminal/` (directory)
7. `Game.Data/Data/Json/npcs/noble/` (directory)
8. `Game.Data/Data/Json/npcs/magical/` (directory)
9. `Game.Data/Data/Json/npcs/religious/` (directory)
10. `Game.Data/Data/Json/npcs/service/` (directory)
11. `Game.Data/Data/Json/npcs/common/catalog.json` (377 lines)
12. `Game.Data/Data/Json/npcs/craftsmen/catalog.json` (451 lines)
13. `Game.Data/Data/Json/npcs/relationships.json` (162 lines)
14. `Game.Data/Data/Json/npcs/schedules.json` (368 lines)
15. `docs/NPC_STRUCTURAL_AUDIT.md` (comprehensive analysis)
16. `docs/NPC_REORGANIZATION_IMPLEMENTATION.md` (implementation guide)
17. `Game.Data/Data/Json/npcs/reorganize-npcs.ps1` (helper script)
